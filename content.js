...
else if (matchingElement2)
{
  //*[@id="detail-bullets"]/table/tbody/tr/td/div[2]/ul/li[1]/b
      ...
      dimensions=matchingElement2.nextSibling.textContent;
  ...
  dimensions=matching_element_product_dimensions_span.nextSibling.nextSibling.textContent;
  dimensions = dimensions.replace(/\s/g,'')
...
// else if()
    ...
    {
    dimensions="Could not find on page"
